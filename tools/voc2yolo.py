...
def parseArgs():
    ...
    parser.add_argument('--xmlpath', type=str, default="E:\\Code\\FireAndSmokeDetect\\dataset\\VOC2020\\Annotations" ,help="the xml files's path")
    parser.add_argument('--imgpath', type=str, default="" ,help="the image's path")
    parser.add_argument('--outputpath', type=str, default="E:\\Code\\FireAndSmokeDetect\\dataset\\VOC2020\\yolo_label" ,help="yolo txt file's output path")
    parser.add_argument('--label', type=str, default="E:\\Code\\FireAndSmokeDetect\\dataset\\VOC2020\\label.txt", help="yolo label file path")
    ...
    for xml in xmlFileNames:
        ...
        for node in annotation.childNodes:
            if node.nodeName == 'object':
                ...
                vocBox = [int(xMin), int(xMax), int(yMin), int(yMax)]
